...
cargo flamegraph --bin="./target/release/splashsurf.exe" \
 ...
 flamegraph -- ./target/release/splashsurf.exe reconstruct ./data/cube_2366_particles.vtk  --start-index=135 --end-index=258   --quiet  -r=0.025 -l=2.0 -c=0.5 -t=0.6  --subdomain-grid=on  --mesh-cleanup=on  --mesh-smoothing-weights=on  --mesh-smoothing-iters=25  --normals=on  --normals-smoothing-iters=10  --mt-files=on --mt-particles=off
