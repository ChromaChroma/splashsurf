...
use crate::{density_map, gpu, Index, marching_cubes, neighborhood_search, OpenCLData, Parameters, profile, Real, ReconstructionError, SurfaceReconstruction};
...
pub(crate) fn reconstruct_surface_subdomain_grid<'a, I: Index, R: Real>(
    ...
    let surface_patches = gpu::dense_subdomains::reconstruction(
        &internal_parameters,
        &particle_positions,
        &particle_densities,
        &subdomains,
