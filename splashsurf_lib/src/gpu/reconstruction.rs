...
use crate::{gpu, Index, Parameters, profile, Real, SurfaceReconstruction};
...
pub(crate) fn reconstruct_surface_subdomain_grid_gpu<'a, I: Index, R: Real>(
    ...
    let subdomains =
        gpu::dense_subdomains::decomposition::<I, R, GhostMarginClassifier<I>>(&internal_parameters, &particle_positions)?;
